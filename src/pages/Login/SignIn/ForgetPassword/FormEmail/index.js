...
export default function FormEmail({ navigation }) {
  ...
  useEffect(() => {
    AsyncStorage.getItem('@gobarberforgetpassword').then((gobarberemail) => {
      if (gobarberemail !== undefined && gobarberemail !== null) {
  ...
  const saveEmail = async () => {
    await AsyncStorage.setItem('@gobarberforgetpassword', email);
  };
